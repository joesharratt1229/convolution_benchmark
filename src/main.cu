...
int main(int argc, char **argv) {
    ...
    constexpr int warps_per_row = seq_len / 32;
    ...
    flash_attention_kernel_wrapper<floatT, accFloatT, embed_dim, seq_len, warps_per_row>(query, key, value, output, num_heads);
